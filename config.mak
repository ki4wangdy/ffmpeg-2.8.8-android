...
DOXYGEN=doxygen
LDFLAGS=  --sysroot=/ndk/android-ndk-r10e/platforms/android-8/arch-arm -isysroot /ndk/android-ndk-r10e/platforms/android-8/arch-arm -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
